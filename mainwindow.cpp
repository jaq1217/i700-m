...
void MainWindow::on_startButton_clicked()
{
    ...
    if(ec_init("ens33"))
    {
        ...
        if(ec_config_init(FALSE) > 0)
        {
            ...
            os=sizeof(ob1); ob1 = 0x60410010;
            ec_SDOwrite(1,0x1a01,01,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60640020;
            ec_SDOwrite(1,0x1a01,02,FALSE,os,&ob1,EC_TIMEOUTRXM);
            ...
            os=sizeof(ob1); ob1 = 0x60410010;
            ec_SDOwrite(1,0x1a02,01,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60640020;
            ec_SDOwrite(1,0x1a02,02,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob3); ob3 = 0x02;
            ec_SDOwrite(1,0x1a02,00,FALSE,os,&ob3,EC_TIMEOUTRXM);
            os=sizeof(ob3); ob3 = 0;
            ec_SDOwrite(1,0x1a03,00,FALSE,os,&ob3,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60410010;
            ec_SDOwrite(1,0x1a03,01,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60640020;
            ec_SDOwrite(1,0x1a03,02,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60770010;
            ec_SDOwrite(1,0x1a03,03,FALSE,os,&ob1,EC_TIMEOUTRXM);
            ...
            os=sizeof(ob1); ob1 = 0x60400010;
            ec_SDOwrite(1,0x1601,01,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60600008;
            ec_SDOwrite(1,0x1601,02,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x607A0020;
            ec_SDOwrite(1,0x1601,03,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob3); ob3 = 0x03;
            ec_SDOwrite(1,0x1601,00,FALSE,os,&ob3,EC_TIMEOUTRXM);
            os=sizeof(ob3); ob3 = 0;
            ec_SDOwrite(1,0x1602,00,FALSE,os,&ob3,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60400010;
            ec_SDOwrite(1,0x1602,01,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60600008;
            ec_SDOwrite(1,0x1602,02,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60FF0020;
            ec_SDOwrite(1,0x1602,03,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob3); ob3 = 0x03;
            ec_SDOwrite(1,0x1602,00,FALSE,os,&ob3,EC_TIMEOUTRXM);
            os=sizeof(ob3); ob3 = 0;
            ec_SDOwrite(1,0x1603,00,FALSE,os,&ob3,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60400010;
            ec_SDOwrite(1,0x1603,01,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60600008;
            ec_SDOwrite(1,0x1603,02,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob1); ob1 = 0x60710010;
            ec_SDOwrite(1,0x1603,03,FALSE,os,&ob1,EC_TIMEOUTRXM);
            os=sizeof(ob3); ob3 = 0x03;
            ec_SDOwrite(1,0x1603,00,FALSE,os,&ob3,EC_TIMEOUTRXM);
...
void MainWindow:: UpStatus()
{
    ...
    if(SendPdo && ec_slave[1].state == EC_STATE_OPERATIONAL)
    {
        ...
        *(ec_slave[1].outputs + 6 ) = (OutputData.TargetPosi & 0xff000000) >> 24;
         str.sprintf(" outputs:%x %x %x %x %x %x %x",*(ec_slave[1].outputs),*(ec_slave[1].outputs+1),*(ec_slave[1].outputs+2),*(ec_slave[1].outputs+3),*(ec_slave[1].outputs+4),*(ec_slave[1].outputs+5),*(ec_slave[1].outputs+6));
         ui->infoBrowser->append(str);
        ec_send_processdata();
        ...
        str.sprintf(" input:%x %x %x %x %x %x", *(ec_slave[1].inputs), *(ec_slave[1].inputs+1), *(ec_slave[1].inputs+2),*(ec_slave[1].inputs+3),*(ec_slave[1].inputs+4),*(ec_slave[1].inputs+5));
        ui->infoBrowser->append(str);
